<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Appsoly.index1" %>
                ...
                <div class="col-12 col-lg-6 ">
                    ...
                    <div class="hero-text-area">
                        <div class="row">
                            ...
                            <div class="col-12       ">
                                <div class="pre-title ">BİLİŞİM ÇÖZÜMLERİ             </div>
                                <h1 class="hero-title  ">En İnovatif Hizmetleri ve İleri Teknoloji BT Çözümlerini  <span class="featured-text">Sunuyoruz!
                            ...
                            <div class="col-10       ">
                                <p class="hero-subtitle ">Bilişim ve Yazılım Sektöründe Hedefimiz Yüksek: İhtiyaçlarınızı Karşılamak İçin Teknoloji ve İnovasyonu Bir Araya Getiriyoruz!</p>
                            </div>
                            <div class="col-12   ">
