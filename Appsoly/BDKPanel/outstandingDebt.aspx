<%@ Page Title="" Language="C#" MasterPageFile="~/BDKPanel/sindex.Master" AutoEventWireup="true" CodeBehind="outstandingDebt.aspx.cs" Inherits="Appsoly.BDKPanel.outstandingDebt" %>
            ...
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="table-responsive">
                        <asp:ListView ID="lv_outstanding" runat="server" DataKeyNames="ID" OnItemCommand="lv_outstanding_ItemCommand">
                            <LayoutTemplate>
